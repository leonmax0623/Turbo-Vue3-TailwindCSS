...
const routes = [
  ...
  { path: '/employers/:id', component: () => import(/* webpackChunkName: "Employers" */ '@/Pages/Office/Employers.vue'), name: 'Employer' },
  ...
  { path: '/kanban', component: () => import(/* webpackChunkName: "Kanban" */ '@/Pages/Office/Kanban.vue'), name: 'Kanban' },
  { path: '/kanban/:view', component: () => import(/* webpackChunkName: "KanbanView" */ '@/Pages/Office/Kanban.vue'), name: 'KanbanView' },
  ...
  { path: '/w/employers/:id', component: () => import(/* webpackChunkName: "WorkerTask" */ '@/Pages/Work/Employer.vue'), name: 'WorkerEmployer' },
...
router.beforeEach((to, from, next) => {
  ...
  const nextRoueFunc = () => {
    if (isSlesar) return { name: 'WorderKanban' };
